...
## What is this?
A c# library I built to practice linear algebra concepts. It was made for the fun of it, and does not include a test project (or many comments) like my normal repositories. This means that I cannot guaruntee everything works correctly, but in all likelihood it should.
